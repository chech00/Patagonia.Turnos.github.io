 // --- Funciones para calcular feriados móviles y formatear fechas ---
  ...
  function asignarTurnos() {
    ...
    // --- Cálculo de fechas de inicio y fin de la semana ---
    ...
    // --- Llamada para guardar el turno en Google Sheets ---
  ...
  function guardarTurnoEnSheet(semana, fechaInicio, fechaFin, tecnico, ingeniero, planta) {
    const url = "https://script.google.com/macros/s/AKfycbyNi9FmLzqLYh0Zd3jTDymKJvr4U2D6BIZgso6jVWqrJWtq6zqMGdLGf1Und3_-hgVUcQ/exec"; // Reemplaza con la URL de tu Web App de Google Apps Script
    const params = {
      method: "post",
      headers: {
  ...
  // --- Funciones de notificación por Telegram (sin cambios) ---
